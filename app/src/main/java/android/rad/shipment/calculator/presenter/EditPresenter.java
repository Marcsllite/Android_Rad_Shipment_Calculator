...
public class EditPresenter extends BasePresenter {
    ...
    /**
     * Constructor to make an edit presenter attached to the given edit dialogue view
     *
     * @param view the edit dialogue view that this presenter will be affecting
     ...
     */
    public EditPresenter(@NonNull final EditDialogueView view, @NonNull final TaskExecutor taskExecutor, ShipmentCalculatorDataSource db){
    ...
    public void onChckBoxSameNSFClicked() {
        if(mView.getChckBoxSameNSF().isChecked()) {
            if (BaseActivity.getShipment().getNSFConsistent()) {
                ...
                BaseActivity.getShipment().setConsistentNSFIndex(mView.getIndex());
            }
        }
    }
    ...
    /**
     * Listener function that is called when the delete button is clicked
     */
    public void onBtnDeleteClicked() {
        BaseActivity.getShipment().removeIsotope(mView.getIndex());
        mView.leaveActivity();
    }

    /**
     * Listener function that is called when the edit button is clicked
     */
