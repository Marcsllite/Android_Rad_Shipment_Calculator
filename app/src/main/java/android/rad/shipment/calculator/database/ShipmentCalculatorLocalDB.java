...
public abstract class ShipmentCalculatorLocalDB extends RoomDatabase {
    private static ShipmentCalculatorLocalDB INSTANCE;
    ...
    public abstract ShortLongDao shortLongDao();

    public synchronized static ShipmentCalculatorLocalDB getInstance(Context context) {
        if (INSTANCE == null) {
            INSTANCE = Room
                    .databaseBuilder(context.getApplicationContext(),
                    ShipmentCalculatorLocalDB.class, "ShipmentCalculatorLocal")
                    .build();
        }
        return INSTANCE;
    }
